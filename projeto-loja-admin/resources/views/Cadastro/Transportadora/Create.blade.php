                        ...
                        <div class="rows">
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" name="razao_social" id="razao_social" required
                                    value="{{ $transportadora->razao_social ?? old('razao_social') }}"
                                    class="form-campo">
                            ...
                            <div class="col-6 mb-3" id="divFantasia">
                                ...
                                <input type="text" name="nome_fantasia" id="nome_fantasia"
                                    value="{{ $transportadora->nome_fantasia ?? old('nome_fantasia') }} "
                            ...
                            <div class="col-3" id="div_tipo_contribuinte">
                                ...
                                <select class="form-campo" name="tipo_contribuinte" id="tipo_contribuinte">
                                    <option value="1" {{ ($transportadora->tipo_contribuinte ?? null) == 1 ? 'selected'
                                        : '' }}>1 -
                                        Contribuinte ICMS</option>
                                    <option value="9" {{ ($transportadora->tipo_contribuinte ?? null) == 9 ? 'selected'
                                        : '' }}>9 -
                                        Não Contribuinte</option>
                                    <option value="2" {{ ($transportadora->tipo_contribuinte ?? null) == 2 ? 'selected'
                                        : '' }}>2 -
                        ...
                        <div class="rows">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" name="logradouro" id="logradouro"
                                    value="{{ $transportadora->logradouro ?? old('logradouro') }}"
                            ...
                            <div class="col-2 mb-2">
                                ...
                                <input type="text" name="uf" id="uf" value="{{ $transportadora->uf ?? old('uf') }}"
