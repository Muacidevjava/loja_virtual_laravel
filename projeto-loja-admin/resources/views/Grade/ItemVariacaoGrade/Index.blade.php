    ...
    <div class="col-12">
        ...
        <div class="caixa">
            ...
            <div class="px-2 py-2 w-100 d-grid">
                ...
                <form action="{{ route('itemvariacaograde.update', $itemvariacaograde->id) }}" method="POST">
                    <input name="_method" type="hidden" value="PUT" />
                    @else
                    <form action="{{ route('itemvariacaograde.store') }}" method="Post">
                        @endif
                        @csrf
                                ...
                                <div class="rows center-middle">
                                    <div class="col-9">
                                        ...
                                        <input type="text" name="valor"
                                            value="{{ isset($itemvariacaograde->valor) ? $itemvariacaograde->valor : null }}"
                                            class="form-campo">
                                    </div>
                ...
                <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table variacaograde">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center"><a href="{{ route('itemvariacaograde.edit', $cat->id) }}"
                                    class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i>
                                    Editar</a> </td>
                            <td align="center">

                                <a href="#"
                                    onclick="confirm('Tem Certeza?') ? document.getElementById('apagar{{ $cat->id }}').submit() : '';"
                                    class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i
                                        class="fas fa-trash-alt"></i></a>
                                <form action="{{ route('itemvariacaograde.destroy', $cat->id) }}" method="POST"
                                    id="apagar{{ $cat->id }}">
