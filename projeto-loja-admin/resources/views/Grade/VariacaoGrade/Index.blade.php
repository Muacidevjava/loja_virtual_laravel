...
<div class="rows">
    <div class="col-12">
        <span class=" bg-title text-light text-uppercase h5 mb-3 text-branco">
            ...
            Lista de variacaogrades
        </span>

        <div class="caixa">

            <div class="px-2 py-2 w-100 d-grid">
                <form action="{{ route('variacaograde.store') }}" method="POST">
                    @csrf

                    <div class="{{ isset($variacaograde->variacao) ? 'bg-edit' : 'caixafield' }}  p-2 radius-4 border">
                            ...
                            <div class="rows center-middle">
                                <div class="col-9">
                                    ...
                                    <input type="text" name="variacao"
                                        value="{{ $variacaograde->variacao ?? old('variacao') }}" class="form-campo">
                                </div>
    ...
    <div class="col-12">
        <div class="px-2">
            <div class="tabela-responsiva pb-4">
                <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table variacaograde">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="left">{{ $l->variacao }}</td>
                            <td align="center">
                                <a href="{{ route('variacaograde.edit', $l->id) }}"
                                ...
                                <a href="javascript:;"
                                    ...
                                    <form action="{{ route('variacaograde.destroy', $l->id) }}" method="POST"
                                        id="apagar{{ $l->id }}">
                                        @method('DELETE')
                                        @csrf
                                    </form>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="#" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i
                                        class="fas fa-edit"></i>
                                    Editar</a>
                                ...
                                <a href="javascript:;"
                                    ...
                                    class="d-inline-flex gap-3 btn btn-outline-vermelho btn-pequeno">
                                    <i class="fas fa-trash-alt"></i>
                                    <form action="#" method="POST" id="apagar2">
